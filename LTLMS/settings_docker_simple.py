"""
Django settings for LTLMS project - Docker version (Simple).

This file contains settings for running the application in Docker containers.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-b5af10c63e**-73bnz^c*+rk5u%-9)!@#5uy5^#^*%r09rm7r1")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get('DATABASE_NAME', 'ltlms'),
        "USER": os.environ.get('DATABASE_USER', 'manager'),
        "PASSWORD": os.environ.get('DATABASE_PASSWORD', 'manger@2025#'),
